...
import 'package:todoshka/app/modules/todos/widgets/todos_list.dart';
import 'package:todoshka/app/widgets/my_delegate.dart';
                          ...
                          actions: [
                            TextButton(
                                ...
                                child: Text('cancel'.tr,
                                    style: context.textTheme.titleMedium
                                        ?.copyWith(color: const Color.fromARGB(255, 240, 167, 189)))),
                            TextButton(
                                onPressed: () {
                                  todoController
                                ...
                                ? selectedDay.isAtSameMomentAs(day)
                                    ? Container(
                                        ...
                                        decoration: const BoxDecoration(
                                          color: Color.fromARGB(255, 243, 146, 214),
